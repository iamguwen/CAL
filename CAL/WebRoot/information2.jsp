...
<html>
  <head>
    ...
    <title>My JSP 'information2.jsp' starting page</title>
           ...
           <div class="one" >
            ...
            <div class="content">
                     <div class="left" id="aside">
                           ...
                           <p style="background:#3A779F;"><a href="${pageContext.request.contextPath}/message/selectMessageBySummary.action" id="five">学习总结</a></p>
                           <p ><a href="admin.jsp" target="_blank"  id="six" style="width:150px;height:40px;display:block;">发表</a></p>
                     </div>
                     <div class="right" id="inform">
                            <div >
                           <h3 align="center" id="title_3">学习总结</h3>
                           <c:forEach var="me" items="${me}">
                           <p style="text-indent:2em;padding:20px;height: 30px;word-wrap:break-word;" id="content_1">${me.time}:${me.content}</p>
                           </c:forEach>
                            </div>
