...
<html>
  <head>
    ...
    <title>My JSP 'information1.jsp' starting page</title>
           ...
           <div class="one" >
            ...
            <div class="content">
                     <div class="left" id="aside">
                           <p  ><a href="${pageContext.request.contextPath}/message/selectMessageByNotice.action" id="three" >通知</a></p>
                           <p  style="background:#3A779F;"><a href="${pageContext.request.contextPath}/message/selectMessageByActivity.action" id="four">近期活动</a></p>
                     ...
                     <div class="right" id="inform">
                            <div >
                           <h3 align="center" id="title_2">近期活动</h3>
                           <c:forEach var="mes" items="${mes}">
                           <p style="text-indent:2em;padding:20px;height: 30px;word-wrap:break-word;" id="content_1">${mes.time}:${mes.content}</p>
                           </c:forEach>
                            </div>
